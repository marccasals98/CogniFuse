...
#SBATCH -q acc_bscls
############# Obligatorias #######################
#SBATCH --time=0-20:00:00               # Consultar batchlim para entender los límites de las particiones. 
################# HOST ###########################
...
#SBATCH --verbose
#SBATCH --output=/gpfs/projects/bsc88/speech/speaker_recognition/outputs/ser_2025/logs/%x_%j.txt
...
srun python scripts/train.py \
	--train_data_dir '/gpfs/projects/bsc88/speech/speaker_recognition/data/msp_podcast/Audios' \
	--validation_data_dir '/gpfs/projects/bsc88/speech/speaker_recognition/data/msp_podcast/Audios' \
	--train_labels_path '/gpfs/projects/bsc88/speech/speaker_recognition/data/msp_podcast/custom_data/generated_training_labels/25_01_02_17_03_37_111942/training_labels.tsv' \
	--validation_labels_path '/gpfs/projects/bsc88/speech/speaker_recognition/data/msp_podcast/custom_data/generated_training_labels/25_01_02_17_03_37_111942/development_labels.tsv' \
	--dataset_transcriptions_dir '/gpfs/projects/bsc88/speech/speaker_recognition/data/msp_podcast/custom_data/generated_transcripts/v1/25_01_04_13_38_12_603360/transcripts' \
